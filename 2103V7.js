...
function loadAnimals(filterType = "", filterValue = "") {
    let container = document.getElementById("animals-container");
    container.innerHTML = ""; // Clear existing content

    animals.forEach(animal => {
        // Check filter
        if (filterType && filterValue !== "Tous" && animal[filterType][taal] !== filterValue) return;
...
// Filter animals by category or habitat
function filterBy(type, value) {
    loadAnimals(type, value);
}
