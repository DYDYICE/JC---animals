...
document.addEventListener("DOMContentLoaded", function () {
    if (typeof animals !== "undefined" && animals.length > 0) {
        ...
        animals.forEach(animal => {
            var infoLink = animal.infoImage || "#";

            var animalItem = document.createElement("a");
            animalItem.classList.add("a-item");
            animalItem.href = infoLink;
            animalItem.target = "_blank";
            animalItem.style.textDecoration = "none";
